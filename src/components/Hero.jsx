      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            ...
            I am a committed software engineer with a talent for designing robust and scalable software systems. With 1 year of practical experience, I have honed my skills in languages such as Python and Java, and frameworks like Django and Node.js. I also have experience with database technologies like SQL. My goal is to leverage my expertise to create innovative software solutions that drive business growth and deliver exceptional user experiences.
            </motion.p>
          </div>
        </div>
